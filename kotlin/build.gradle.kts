...
dependencies {
    ...
    implementation("dev.langchain4j:langchain4j:1.19.2")
    ...
    implementation("dev.langchain4j:langchain4j-ollama:1.19.2")
    ...
    implementation("org.apache.opennlp:opennlp-tools:2.5.12")
}
